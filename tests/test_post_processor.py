...
class TestPostProcessor(unittest.TestCase):
    ...
    def test_resample_timeframe(self):
        ...
        assert str(df.loc['2017-12-29 09:00:00']['Open']) == "170.71"
        assert str(df.loc['2017-12-29 09:00:00']['High']) == "170.71"
        assert str(df.loc['2017-12-29 09:00:00']['Low']) == "169.71"
        assert str(df.loc['2017-12-29 09:00:00']['Close']) == "169.93"

        # Assert 2017-12-29 10:00: O=169.92, H=169.95, L=169.31, C=169.64
        assert str(df.loc['2017-12-29 10:00:00']['Open']) == "169.92"
        assert str(df.loc['2017-12-29 10:00:00']['High']) == "169.95"
        assert str(df.loc['2017-12-29 10:00:00']['Low']) == "169.31"
        assert str(df.loc['2017-12-29 10:00:00']['Close']) == "169.64"

        # Assert 2017-12-29 16:00: O=169.23
        assert str(df.loc['2017-12-29 16:00:00']['Open']) == "169.23"
